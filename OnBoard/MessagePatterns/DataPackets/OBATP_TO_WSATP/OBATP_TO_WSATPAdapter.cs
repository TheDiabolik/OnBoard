...
namespace OnBoard
{
    public class OBATP_TO_WSATPAdapter : OBATP_TO_WSATP
    {
        ...
        {
            base.EmergencyBrakeApplied =   Convert.ToByte(_adaptee.EmergencyBrakeApplied);
            base.TrainAbsoluteZeroSpeed = Convert.ToByte(_adaptee.TrainAbsoluteZeroSpeed);
            base.AllTrainDoorsClosedAndLocked = Convert.ToByte(_adaptee.AllTrainDoorsClosedAndLocked);
            ...
            base.TrainIntegrity = Convert.ToByte(_adaptee.TrainIntegrity);
            base.TrainLocationDeterminationFault = Convert.ToByte(_adaptee.TrainLocationDeterminationFault);
            ...
            base.TrainDerailment = Convert.ToByte(_adaptee.TrainDerailment);
