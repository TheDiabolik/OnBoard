...
namespace OnBoard
{
    class OBATP_TO_WSATPAdaptee
    {
        ...
        public OBATP_TO_WSATPAdaptee(OBATP OBATP)
        {
            ...
            ushort[] footPrintTracks = FindTrackRangeInAllTracks(OBATP.FrontOfTrainTrackWithFootPrint.Track, OBATP.RearOfTrainTrackWithFootPrint.Track, MainForm.allTracks);
            ushort[] virtualOccupationTracks = FindTrackRangeInAllTracks(OBATP.FrontOfTrainVirtualOccupation.Track, OBATP.RearOfTrainVirtualOccupation.Track, MainForm.allTracks);
