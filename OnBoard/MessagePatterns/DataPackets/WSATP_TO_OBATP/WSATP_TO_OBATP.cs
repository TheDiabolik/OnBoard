...
namespace OnBoard
{
    public class WSATP_TO_OBATP : IMessageType, IDisposable
    {
        ...
        public byte[] ToByte()
        {
            ...
            result.Add(Convert.ToByte(this.TrackSectionID1));
            result.Add(this.SpeedLimit1);

            result.Add(Convert.ToByte(this.TrackSectionID2));
            result.Add(this.SpeedLimit2);  

            result.Add(Convert.ToByte(this.TrackSectionID3));
            result.Add(this.SpeedLimit3);

            result.Add(Convert.ToByte(this.TrackSectionID4));
            result.Add(this.SpeedLimit4);

            result.Add(Convert.ToByte(this.TrackSectionID5));
            result.Add(this.SpeedLimit5);



            result.Add(Convert.ToByte(this.TrackSectionID6));
            result.Add(this.SpeedLimit6);

            result.Add(Convert.ToByte(this.TrackSectionID7));
            result.Add(this.SpeedLimit7);

            result.Add(Convert.ToByte(this.TrackSectionID8));
            result.Add(this.SpeedLimit8);

            result.Add(Convert.ToByte(this.TrackSectionID9));
            result.Add(this.SpeedLimit9);

            result.Add(Convert.ToByte(this.TrackSectionID10));
            result.Add(this.SpeedLimit10);


            result.Add(Convert.ToByte(this.TrackSectionID11));
            result.Add(this.SpeedLimit11);

            result.Add(Convert.ToByte(this.TrackSectionID12));
            result.Add(this.SpeedLimit12);

            result.Add(Convert.ToByte(this.TrackSectionID13));
            result.Add(this.SpeedLimit13);

            result.Add(Convert.ToByte(this.TrackSectionID14));
            result.Add(this.SpeedLimit14);

            result.Add(Convert.ToByte(this.TrackSectionID15));
            result.Add(this.SpeedLimit15);

            result.Add(Convert.ToByte(this.TrackSectionID16));
            result.Add(this.SpeedLimit16);

            result.Add(Convert.ToByte(this.TrackSectionID17));
            result.Add(this.SpeedLimit17);

            result.Add(Convert.ToByte(this.TrackSectionID18));
            result.Add(this.SpeedLimit18);

            result.Add(Convert.ToByte(this.TrackSectionID19));
            result.Add(this.SpeedLimit19);

            result.Add(Convert.ToByte(this.TrackSectionID20));
