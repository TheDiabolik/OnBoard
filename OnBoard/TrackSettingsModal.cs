    ...
    public partial class TrackSettingsModal : Form
    {
        ...
        public TrackSettingsModal()
        {
            ...
            if (m_settings.RouteTrack.TableName == "")
                m_dataGridViewTrackRoute.DataSource = TempDataTable();
            else
                m_dataGridViewTrackRoute.DataSource = m_settings.RouteTrack;

            m_dataGridViewTrackRoute.Columns[0].Width = 50;


            typeof(DataGridView).InvokeMember("DoubleBuffered", BindingFlags.SetProperty
           | BindingFlags.Instance | BindingFlags.NonPublic, null,
           m_dataGridViewTrackRoute, new object[] { true });
        ...
        private void m_buttonSave_Click(object sender, EventArgs e)
        {
            ...
            DataTable dT = (DataTable)m_dataGridViewTrackRoute.DataSource;
        ...
        private void m_dataGridViewTrackRoute_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            ...
            foreach (DataGridViewRow row in m_dataGridViewTrackRoute.Rows)
            {
